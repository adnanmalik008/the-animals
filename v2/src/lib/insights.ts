...
const DEFAULT_STATE: StoreState = {
  circles: [
    ...
    { id: "name-1", name: "Name", color: "yellow", icon: "signal", size: "sm", builtIn: true },
    { id: "name-2", name: "Name", color: "purple", icon: "signal", size: "sm", builtIn: true },
  ],
  insights: [
    ...
    { id: "seed-x1", circleId: "name-1", headline: "MI5 warns of Chinese operatives using LinkedIn", source: "The New York Times", category: "Business", categoryColor: "blue", createdAt: 11 },
